...
const swapInstances = () => {
    ...
    // todo Currrently, this just returns the parameters for the call to 'setInstances'.
    return consumers.then(consumers => dispensers.then(dispensers => consumers.concat(dispensers)));
};
...
/* todo Modify this to accept an object argument like below:
{
...
*/
const setInstances = (elb_name, instances) => {
