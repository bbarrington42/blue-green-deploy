...
const curriedSetInstances = (elb_name, instances) => setInstances(classic_elb, elb_name, instances);
const curriedInventory = (elb_names) => inventory(classic_elb, elb_names);
const curriedProdColor = () => prodColor(classic_elb);

module.exports = {
    setInstances: curriedSetInstances,
    inventory: curriedInventory,
    prodColor: curriedProdColor
};
