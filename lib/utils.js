...
LoadBalancerDescriptions:
   [ { LoadBalancerName: 'cda-consu-ElasticL-BK5LOE3X0J1A',
       DNSName:
        'cda-consu-ElasticL-BK5LOE3X0J1A-876461607.us-east-1.elb.amazonaws.com',
 */

// Return a list of all load balancers. Each entry will be of the form
// {LoadBalancerName: 'cda-consu-ElasticL-BK5LOE3X0J1A',
//  Addresses: [ '1.1.1.1', '2.2.2.2' ] }
const loadBalancers = () => classic_elb.describeLoadBalancers().promise().then(elbs => _.map(elbs.LoadBalancerDescriptions, elb => {
    //console.log(elb);
    return {LoadBalancerName: elb.LoadBalancerName, DNSName: elb.DNSName}
}));
